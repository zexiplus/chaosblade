...
VERSION_PKG=github.com/zexiplus/chaosblade/version
# Specify chaosblade version in docker experiments
CRI_BLADE_VERSION=github.com/zexiplus/chaosblade-exec-cri/version
OS_BLADE_VERSION=github.com/zexiplus/chaosblade-exec-os/version
JVM_BLADE_VERSION=github.com/zexiplus/chaosblade-exec-jvm/version
K8S_BLADE_VERSION=github.com/zexiplus/chaosblade-operator/version
...
# chaosblade-exec-os
BLADE_EXEC_OS_PROJECT=https://github.com/zexiplus/chaosblade-exec-os.git
BLADE_EXEC_OS_BRANCH=master

# chaosblade-exec-middleware
BLADE_EXEC_MIDDLEWARE_PROJECT=https://github.com/zexiplus/chaosblade-exec-middleware.git
BLADE_EXEC_MIDDLEWARE_BRANCH=main

# chaosblade-exec-cloud
BLADE_EXEC_CLOUD_PROJECT=https://github.com/zexiplus/chaosblade-exec-cloud.git
BLADE_EXEC_CLOUD_BRANCH=main

# chaosblade-exec-cri
BLADE_EXEC_CRI_PROJECT=https://github.com/zexiplus/chaosblade-exec-cri.git
BLADE_EXEC_CRI_BRANCH=main

# chaosblade-exec-kubernetes
BLADE_OPERATOR_PROJECT=https://github.com/zexiplus/chaosblade-operator.git
BLADE_OPERATOR_BRANCH=master

# chaosblade-exec-jvm
BLADE_EXEC_JVM_PROJECT=https://github.com/zexiplus/chaosblade-exec-jvm.git
BLADE_EXEC_JVM_BRANCH=master

# chaosblade-exec-cplus
BLADE_EXEC_CPLUS_PROJECT=https://github.com/zexiplus/chaosblade-exec-cplus.git
...
help:
	...
	@echo 'For details refer to https://github.com/zexiplus/chaosblade/wiki/ChaosBlade-Projects-Compilation'
...
build_linux_with_arg:
	docker run --rm \
		...
		-w /go/src/github.com/zexiplus/chaosblade \
		-v ~/.m2/repository:/root/.m2/repository \
		-v  /home/chaosblade/:/home/chaosblade/ \
        -v $(shell pwd):/go/src/github.com/zexiplus/chaosblade \
