...
require (
	github.com/lomoonmoonbird/chaosblade-exec-cloud v1.8.3
	github.com/lomoonmoonbird/chaosblade-exec-cri v1.8.3
	github.com/lomoonmoonbird/chaosblade-exec-middleware v1.8.3
	github.com/lomoonmoonbird/chaosblade-exec-os v1.8.3
	github.com/lomoonmoonbird/chaosblade-operator v1.8.3
